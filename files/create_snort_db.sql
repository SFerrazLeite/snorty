...
CREATE TABLE IF NOT EXISTS `schema` ( vseq        INT      UNSIGNED NOT NULL,
                      ...
                      PRIMARY KEY (vseq));
INSERT IGNORE INTO `schema`  (vseq, ctime) VALUES ('107', now());       

CREATE TABLE IF NOT EXISTS event  ( sid 	  INT 	   UNSIGNED NOT NULL,
...
CREATE TABLE IF NOT EXISTS signature ( sig_id       INT          UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS sig_reference (sig_id  INT    UNSIGNED NOT NULL,
                            ref_seq INT    UNSIGNED NOT NULL,
                            ref_id  INT    UNSIGNED NOT NULL,
                            PRIMARY KEY(sig_id, ref_seq));

CREATE TABLE IF NOT EXISTS reference (  ref_id        INT         UNSIGNED NOT NULL AUTO_INCREMENT,
                          ref_system_id INT         UNSIGNED NOT NULL,
                          ref_tag       TEXT NOT NULL,
                          PRIMARY KEY (ref_id));

CREATE TABLE IF NOT EXISTS reference_system ( ref_system_id   INT         UNSIGNED NOT NULL AUTO_INCREMENT,
                                ref_system_name VARCHAR(20),
                                PRIMARY KEY (ref_system_id));

CREATE TABLE IF NOT EXISTS sig_class ( sig_class_id        INT    UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS sensor ( sid	  INT 	   UNSIGNED NOT NULL AUTO_INCREMENT,
                      hostname    TEXT,
                      interface   TEXT,
                      filter	  TEXT,
                      detail	  TINYINT,
...
CREATE TABLE IF NOT EXISTS iphdr  ( sid 	  INT 	   UNSIGNED NOT NULL,
                      cid 	  INT 	   UNSIGNED NOT NULL,
...
CREATE TABLE IF NOT EXISTS tcphdr(  sid 	  INT 	   UNSIGNED NOT NULL,
                      cid 	  INT 	   UNSIGNED NOT NULL,
...
CREATE TABLE IF NOT EXISTS udphdr(  sid 	  INT 	   UNSIGNED NOT NULL,
                      cid 	  INT 	   UNSIGNED NOT NULL,
...
CREATE TABLE IF NOT EXISTS icmphdr( sid 	  INT 	   UNSIGNED NOT NULL,
                      cid 	  INT  	   UNSIGNED NOT NULL,
...
# Protocol options
CREATE TABLE IF NOT EXISTS opt    ( sid         INT      UNSIGNED NOT NULL,
                      cid         INT      UNSIGNED NOT NULL,
...
# Packet payload
CREATE TABLE IF NOT EXISTS data   ( sid           INT      UNSIGNED NOT NULL,
                      cid           INT      UNSIGNED NOT NULL,
                      data_payload  TEXT,
                      PRIMARY KEY (sid,cid));
...
INSERT IGNORE INTO encoding (encoding_type, encoding_text) VALUES (0, 'hex');
INSERT IGNORE INTO encoding (encoding_type, encoding_text) VALUES (1, 'base64');
INSERT IGNORE INTO encoding (encoding_type, encoding_text) VALUES (2, 'ascii');
...
INSERT IGNORE INTO detail (detail_type, detail_text) VALUES (0, 'fast');
INSERT IGNORE INTO detail (detail_type, detail_text) VALUES (1, 'full');
